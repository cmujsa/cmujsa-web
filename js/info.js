...
const mainContactName = "Mia Manton"; // Will be used in FAQ
const mainContactAndrewID = "mmanton"; // Will be used in FAQ and footer
...
Array.from(document.getElementsByClassName("main-contact-name")).forEach(
  function (element) {
    element.innerHTML = mainContactName;
  },
);
Array.from(document.getElementsByClassName("main-contact-andrewID")).forEach(
  function (element) {
